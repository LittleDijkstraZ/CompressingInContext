...
DEFAULT_ROTATION=2048
DEFAULT_DATA_LIMIT=3
DEFAULT_MODE=takeaways
DEFAULT_NUM_EPOCHS=1

# Tunable values (excluding defaults - defaults are only run once at the start)
TUNE_BUDGETS="256 1024 2048 4096 8192"
TUNE_WINDOW_SIZES="64 256"
TUNE_ROTATIONS="none 16 256 1024 4096 8192"
TUNE_DATA_LIMITS="1 2 5 8 13"
TUNE_MODES="notepad none"
TUNE_NUM_EPOCHS="3 5"

# Set directories (modify these as needed)
CACHE_DIR=./kv_caches_tune
RESULTS_DIR=./results_grid_search_tune
